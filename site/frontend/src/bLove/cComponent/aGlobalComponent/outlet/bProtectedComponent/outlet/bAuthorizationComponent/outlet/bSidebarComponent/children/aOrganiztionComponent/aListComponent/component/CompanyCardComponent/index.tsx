...
const CompanyCardComponent = ({ id, companyName, firmType, contactInfo, address }: any) => {
  return (
    <MainContainer>
      <CardLink to={`${fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.aOrganizationRoute.cRetrieveRoute}/${id}`}>
        <Card>
