...
const apiResponseHandler = {
  ...
  updateAPIResponseHandler: async (data: any, updateAPITrigger: any, navigate: any, enrolledServiceCreateAPITrigger: any, licenseCreateAPITrigger: any, organizationRetrieve: any) => {
    try {
