...
const apiResponseHandler = {
  updateAPIResponseHandler: async (data: any, updateAPITrigger: any, navigate: NavigateFunction, params: any) => {
  ...
  deleteAPIResponseHandler: async (_data: any, deleteAPITrigger: any, navigate: NavigateFunction, params: any) => {
