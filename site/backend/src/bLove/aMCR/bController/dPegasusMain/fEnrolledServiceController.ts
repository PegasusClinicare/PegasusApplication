...
import { EnrolledServiceModel } from '../../aModel/dPegasusMain/fEnrolledServiceModel';


const enrolledServiceController = (Model=EnrolledServiceModel, Label="EnrolledService") => ({
  // List
  list: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      const list = await Model.find()
        ...
        .populate("cOrganization", "aTitle bCreatedBy dAddress")
        .populate("cService", "aTitle dFormType dCategory dOwnLoan dGovtFees dOurFees dAddedDate dServiceValidity");
...
export default enrolledServiceController;
